        ...
        <section style={{ marginBottom: 80 }}>
          ...
          {featured && (
            <div className="mob-col" style={{
              ...
              <div style={{ background: T.surface2, display: "flex", alignItems: "center", justifyContent: "center", borderLeft: `1px solid ${T.border}`, padding: 40 }}>
                <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke={T.green} strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.5 }}><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
              </div>
            </div>
          )}
        </section>
